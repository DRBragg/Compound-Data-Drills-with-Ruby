def twitter_data
   ...
   {"description"=>nil,
    "last twenty tweets"=>
     ["Huge breakthrough on my breakable toy today...can upload local file to soundcloud from my app...time for a beer! #LaunchAcademy",
      ...
      "RT @resilientcoders: Team Resilient at the @LaunchAcademy Ship it Saturday. Big thx to @STWatkins78 for lending his expertise in rails! ht…",
 ...
 {"chrisccerami"=>
   {"description"=>
     "Environmental Scientist | BS in Biology | Soon to be @LaunchAcademy student | Aspiring Web Developer",
    "last twenty tweets"=>
     ["@dongiovannirecs @screamales here's where it's hosted right now if you want to check out the interactive map https://t.co/NkgVIXNPxf",
      ...
      "@JustusEapen @LaunchAcademy @MarsCuriosity https://t.co/W6IBpIuIr0",
 ...
 {"spencercdixon"=>
   {"description"=>
     "Software Developer & Mentor @LaunchAcademy | Cutco FSM | Ruby Enthusiast | Outdoor Adventurer",
    "last twenty tweets"=>
   ...
   {"description"=>
    ...
    "last twenty tweets"=>
     ["How many new supporters do you think this led to? - Protests on I-93 Cause Major Traffic Delays; 17 Arrested http://t.co/L1XqhUZRdm",
      ...
      "New Year, New Talent @LaunchAcademy. Come meet our phenomenal Winter cohort at Career Day 1/27 or 1/28 - http://t.co/2EeHzUOlD7.",
      ...
      "RT @LaunchAcademy: Kick off 2015 in style by building awesome projects! Join us @ Ship It! Saturday on 1/10. RSVP now: http://t.co/Gp9ncWr…",
   ...
   {"description"=>nil,
    "last twenty tweets"=>
     ["@lizvdk You are awesome! It will all be good!",
      ...
      "Either I am a crazy person babbling to myself or I am a Launcher planning her Career Day pitch. You decide. @LaunchAcademy",
      ...
      "That moment when you are scanning Twitter and you're all like 'What's with all of these instance variables?' #toomuchRuby @LaunchAcademy",
      ...
      "Some thoughts on remaining calm (even in an interview!) after @flomotlik's talk at @LaunchAcademy last week: http://t.co/kFgvCD4jmm",
   ...
   {"description"=>
    ...
    "last twenty tweets"=>
     ["RT @AP: Cartoonists around the world draw in support of those slain at French magazine Charlie Hebdo: http://t.co/nhVLlLcpLc",
      ...
      "RT @CodeForBoston: Great to see so many @LaunchAcademy members at tonight's #weeklyhacknight! #cfabrigade",
 ...
 {"hchood"=>
   {"description"=>
     "software developer at @Intpd // former instructor at @LaunchAcademy",
    "last twenty tweets"=>
     ["@bcardarella no problem, thanks for the great walk-through!",
      ...
      "Desktop smores. Courtesy of Lauren Glicksteen. @LaunchAcademy http://t.co/lMtFd3NfXQ",
      "@janetdchuang going to be a developer at Intrepid Pursuits.  Super psyched but also super sad :(",
      "didn't quite make it to Friday without waterworks-ing.  I'm gonna miss this place and all the awesome people here -  @LaunchAcademy",
      "Omid and progeny http://t.co/IOHRqpxdwY",
      "Winning Christmas so hard right now http://t.co/hPD2o2sui2",
      "#truth http://t.co/2pnwRTcSdC",
      "@kdaigle - \"Ask questions, check your pride.\" Hear, hear. At @LaunchAcademy",
      "Anyone want tickets to Interpol at HOB tonight? Much as I love them I need a night in.",
      "RT @evancharlz: Friday Fun Time via Launch Votes @LaunchAcademy with @hchood http://t.co/ZrY4rAt2az",
 ...
 {"julissaJM"=>
   {"description"=>
     "Julissa Jansen | Ruby on Rails Developer | @LaunchAcademy alum",
    "last twenty tweets"=>
   ...
   {"description"=>
    ...
    "last twenty tweets"=>
     ["Listening to Dashboard all morning. I think today is going to be awesome. #dashboardconfessional #deskconfessional",
      ...
      "Over a year out of @LaunchAcademy, and fixing my own Rails problems is still such a joy. #developerlove #geekery"],
 ...
 {"alacritythief"=>
   {"description"=>
     "Web Developer + Illustrator. Web Engineer at @CogoLabs. Graduate of @LaunchAcademy.",
    "last twenty tweets"=>
     ["Hey @TobitronKahn ! Send me an email to alacritystudios@gmail.com and I'll be happy to answer any questions you may have.",
      "The game I made in JavaScript using Phaser.io on #shipitsaturday at @LaunchAcademy is now online, at http://t.co/HnpuJzjP3s. Enjoy!",
      ...
      "My team's app project, \"Caturday Funtime\" is now live! GO SIGN UP and post and rate cats at https://t.co/SEsqHPnXiw ! Thanks @LaunchAcademy",
      ...
      "Made an app on #shipit Saturday! @LaunchAcademy http://t.co/d2mhdYELW2",
...
def dataFromTwitter(targetData)
  twitter_data.each_with_index do |data, index|
    data.each_key do |key|
      print "#{key}: "
      if twitter_data[index][key][targetData].nil?
        puts "N/A"
      else
        puts twitter_data[index][key][targetData]
      end
    end
  end
end

def stringLength(targetData)
  twitter_data.each_with_index do |data, index|
    data.each_key do |key|
      string = twitter_data[index][key][targetData]
      puts "#{key}'s latest tweet was #{string.length} characters long."
    end
  end
end

def tweetsLength(targetData)
  twitter_data.each_with_index do |data, index|
    data.each_key do |key|
      total = 0
      twitter_data[index][key][targetData].each {|string| total += string.length}
      puts "#{key} used #{total} characters in their last twenty tweets."
    end
  end
end
...
dataFromTwitter("description")
puts "\n"
dataFromTwitter("number of followers")
puts "\n"
stringLength("latest tweet")
puts "\n"
tweetsLength("last twenty tweets")
puts "\n"
puts "Who has the most twitter followers?"
mostTwitter("number of followers")
puts "\n"
puts "Who has the most friends?"
mostTwitter("number of friends")
puts "\n"
puts "Which users have a description listed in twitter_data?"
hasData("description")
puts "\n"
